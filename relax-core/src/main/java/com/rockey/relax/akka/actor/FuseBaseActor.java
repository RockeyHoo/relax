...
import com.rockey.relax.akka.message.*;
import com.rockey.relax.akka.syslog.SystemLogMessage;
...
public abstract class FuseBaseActor extends UntypedActor {
    ...
    protected void info(String message) {
        ...
        SystemLogMessage.LogMessageBuilder builder = SystemLogMessage.builder();
        
        SystemLogMessage logmessage 
            = builder.withLevel(SystemLogMessage.LogLevel.INFO)
                     .withMessage(message)
                     .build();
