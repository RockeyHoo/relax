package com.rockey.relax.config.route;


import akka.actor.ActorRef;
import com.rockey.relax.akka.actor.StaticContentActor;
import com.rockey.relax.config.ConfigSource;
import com.rockey.relax.config.actor.ActorFactory;
...
public class RoutesConfigImpl implements RoutesConfig {
    ...
    public void addEndpoint(ActorRef ref, String httpMethod, String path) {
        ...
        RouteHandler.RouteHandlerBuilder builder = RouteHandler.builder()
    ...
    void processRouteEntry(Entry<String, ConfigValue> entry) {
        ...
        Optional<RouteHandler.RouteHandlerBuilder> builder = processActorDefinition(entry.getValue());
    ...
    Optional<RouteHandler.RouteHandlerBuilder> processActorDefinition(ConfigValue cvalue) {
    ...
    void processPathDefinition(String path, RouteHandler.RouteHandlerBuilder handlerBuilder) {

        RouteSegment segment = root;
        RouteSegment.RouteSegmentBuilder builder = RouteSegment.builder();
    ...
    private RouteSegment processSegment(String value, boolean more, RouteSegment.RouteSegmentBuilder builder, RouteSegment parent, RouteHandler handler) {
